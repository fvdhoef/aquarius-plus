...
static void AND_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	doAND(ctx, read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++)));
}

static void AND_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	doAND(ctx, read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++)));
}
...
static void BIT_0_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 2;
	uint16_t address = WR.IX + (int8_t) read8(ctx, ctx->PC++);
...
static void BIT_0_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 2;
	uint16_t address = WR.IY + (int8_t) read8(ctx, ctx->PC++);
	doBIT_indexed(ctx, 0, address);
}
...
static void LD_off_IX_d_A(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++), BR.A);
...
static void LD_off_IX_d_B(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++), BR.B);
...
static void LD_off_IX_d_C(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++), BR.C);
...
static void LD_off_IX_d_D(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++), BR.D);
...
static void LD_off_IX_d_E(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++), BR.E);
...
static void LD_off_IX_d_H(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++), BR.H);
...
static void LD_off_IX_d_L(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++), BR.L);
...
static void LD_off_IY_d_A(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++), BR.A);
...
static void LD_off_IY_d_B(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++), BR.B);
...
static void LD_off_IY_d_C(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++), BR.C);
...
static void LD_off_IY_d_D(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++), BR.D);
...
static void LD_off_IY_d_E(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++), BR.E);
...
static void LD_off_IY_d_H(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++), BR.H);
...
static void LD_off_IY_d_L(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	write8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++), BR.L);
...
static void LD_A_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.A = read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++));
}

static void LD_A_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.A = read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++));
}
...
static void LD_B_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.B = read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++));
}

static void LD_B_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.B = read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++));
}
...
static void LD_C_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.C = read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++));
}

static void LD_C_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.C = read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++));
}
...
static void LD_D_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.D = read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++));
}

static void LD_D_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.D = read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++));
}
...
static void LD_E_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.E = read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++));
}

static void LD_E_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.E = read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++));
}
...
static void LD_H_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.H = read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++));
}

static void LD_H_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.H = read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++));
}
...
static void LD_L_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.L = read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++));
}

static void LD_L_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	BR.L = read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++));
}
...
static void OR_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	doOR(ctx, read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++)));
}

static void OR_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	doOR(ctx, read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++)));
}
...
static void XOR_off_IX_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	doXOR(ctx, read8(ctx, WR.IX + (int8_t) read8(ctx, ctx->PC++)));
}

static void XOR_off_IY_d(Z80Context* ctx) {
    (void)ctx;
	ctx->tstates += 5;
	doXOR(ctx, read8(ctx, WR.IY + (int8_t) read8(ctx, ctx->PC++)));
}
