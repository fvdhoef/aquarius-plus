...
vlib work
vmap work work
vlog glbl.v is61c5128as.v tb.v ../*.v ../util/*.v ../wrappers/*.v ../cores/aquarius-plus/*.v ../cores/aquarius-plus/aqplus_common/*.v ../cores/aquarius-plus/aqplus_common/video/*.v ../cores/aquarius-plus/wrappers/*.v
