...
const char *NimBLEUtils::returnCodeToString(int rc) {
    switch (rc) {
        ...
        case (0x0100 + BLE_ATT_ERR_UNSUPPORTED_GROUP): return "The attribute type is not a supported grouping attribute as defined by a higher layer specification.";
        ...
        case (0x0400 + BLE_SM_ERR_PASSKEY): return "The user input of passkey failed, for example, the user cancelled the operation.";
        case (0x0400 + BLE_SM_ERR_OOB): return "The OOB data is not available.";
        case (0x0400 + BLE_SM_ERR_AUTHREQ): return "The pairing procedure cannot be performed as authentication requirements cannot be met due to IO capabilities of one or both devices.";
        ...
        case (0x0400 + BLE_SM_ERR_REPEATED): return "Pairing or authentication procedure disallowed, too little time has elapsed since last pairing request or security request.";
        ...
        case (0x0400 + BLE_SM_ERR_CROSS_TRANS): return "BR/EDR Link Key generated on the BR/EDR transport cannot be used to derive and distribute keys for the LE transport.";
        case (0x0500 + BLE_SM_ERR_PASSKEY): return "The user input of passkey failed or the user cancelled the operation.";
        case (0x0500 + BLE_SM_ERR_OOB): return "The OOB data is not available.";
        case (0x0500 + BLE_SM_ERR_AUTHREQ): return "The pairing procedure cannot be performed as authentication requirements cannot be met due to IO capabilities of one or both devices.";
        ...
        case (0x0500 + BLE_SM_ERR_REPEATED): return "Pairing or authentication procedure is disallowed because too little time has elapsed since last pairing request or security request.";
        case (0x0500 + BLE_SM_ERR_INVAL): return "Command length is invalid or a parameter is outside of the specified range.";
        case (0x0500 + BLE_SM_ERR_DHKEY): return "Indicates to the remote device that the DHKey Check value received doesn’t match the one calculated by the local device.";
        ...
        case (0x0500 + BLE_SM_ERR_CROSS_TRANS): return "BR/EDR Link Key generated on the BR/EDR transport cannot be used to derive and distribute keys for the LE transport.";
...
const char *NimBLEUtils::gapEventToString(uint8_t eventType) {
    switch (eventType) {
        case BLE_GAP_EVENT_CONNECT: return "BLE_GAP_EVENT_CONNECT ";                        // 0
        case BLE_GAP_EVENT_DISCONNECT: return "BLE_GAP_EVENT_DISCONNECT";                   // 1
        case BLE_GAP_EVENT_CONN_UPDATE: return "BLE_GAP_EVENT_CONN_UPDATE";                 // 3
        case BLE_GAP_EVENT_CONN_UPDATE_REQ: return "BLE_GAP_EVENT_CONN_UPDATE_REQ";         // 4
        case BLE_GAP_EVENT_L2CAP_UPDATE_REQ: return "BLE_GAP_EVENT_L2CAP_UPDATE_REQ";       // 5
        case BLE_GAP_EVENT_TERM_FAILURE: return "BLE_GAP_EVENT_TERM_FAILURE";               // 6
        case BLE_GAP_EVENT_DISC: return "BLE_GAP_EVENT_DISC";                               // 7
        case BLE_GAP_EVENT_DISC_COMPLETE: return "BLE_GAP_EVENT_DISC_COMPLETE";             // 8
        case BLE_GAP_EVENT_ADV_COMPLETE: return "BLE_GAP_EVENT_ADV_COMPLETE";               // 9
        case BLE_GAP_EVENT_ENC_CHANGE: return "BLE_GAP_EVENT_ENC_CHANGE";                   // 10
        case BLE_GAP_EVENT_PASSKEY_ACTION: return "BLE_GAP_EVENT_PASSKEY_ACTION";           // 11
        case BLE_GAP_EVENT_NOTIFY_RX: return "BLE_GAP_EVENT_NOTIFY_RX";                     // 12
        case BLE_GAP_EVENT_NOTIFY_TX: return "BLE_GAP_EVENT_NOTIFY_TX";                     // 13
        case BLE_GAP_EVENT_SUBSCRIBE: return "BLE_GAP_EVENT_SUBSCRIBE";                     // 14
        case BLE_GAP_EVENT_MTU: return "BLE_GAP_EVENT_MTU";                                 // 15
        case BLE_GAP_EVENT_IDENTITY_RESOLVED: return "BLE_GAP_EVENT_IDENTITY_RESOLVED";     // 16
        case BLE_GAP_EVENT_REPEAT_PAIRING: return "BLE_GAP_EVENT_REPEAT_PAIRING";           // 17
        case BLE_GAP_EVENT_PHY_UPDATE_COMPLETE: return "BLE_GAP_EVENT_PHY_UPDATE_COMPLETE"; // 18
        case BLE_GAP_EVENT_EXT_DISC: return "BLE_GAP_EVENT_EXT_DISC";                       // 19
        case BLE_GAP_EVENT_PERIODIC_SYNC: return "BLE_GAP_EVENT_PERIODIC_SYNC";             // 20
