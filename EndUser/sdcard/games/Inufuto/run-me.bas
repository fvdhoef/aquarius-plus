...
101 REM 09 AUG 2023 by Sean Harrington
102 A$=""
999 REM ------------------------------
...
1012 GOSUB 9000
1013 IF A$="," GOTO 1130:REM Previous
...
1124 IF A$="." GOTO 1130:REM Next
1125 IF A$=CHR$(13) GOTO 3120:REM Loader
1126 GOSUB 2000:REM Check letters
1127 A$=""
1128 GOTO 1122:REM Loop
1129 REM ------------------------------
1130 REM Cracky Splash
1131 CD"scr":LOAD"inuf-m00.scr",12288:CD".."
1132 GOSUB 9000:REM Quick Pause and INKEY read
1133 IF A$="," GOTO 1120:REM Previous
1134 IF A$="." GOTO 1010:REM Next
1135 IF A$=CHR$(13) GOTO 3130:REM Loader
1136 GOSUB 2000:REM Check letters
1137 A$=""
1138 GOTO 1132:REM Loop
1139 REM ------------------------------
1140 REM New games go here
1999 REM ------------------------------
...
3122 END
3130 REM Cracky Loader
3131 CD"data":RUN"cracky.bas"
3132 END
3140 REM New games go here
3141 END
