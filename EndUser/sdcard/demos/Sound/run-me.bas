...
115 REM C1 in ch-a0
116 LOAD"data/six-c1.scr",12288
120 PSG 0,45,1,4
121 REM ch-a0 on
122 PSG 7,62
125 GOSUB 900:REM 500 tick delay
128 REM E2 in ch-b0
129 LOAD"data/six-e2.scr",12288
130 PSG 2,80,3,3
131 REM ch-a0,b0 on
132 PSG 7,60
135 GOSUB 900:REM 500 tick delay
138 REM G2 in ch-c0
139 LOAD"data/six-g2.scr",12288
140 PSG 4,201,5,2
...
218 REM C3 in ch-a1
219 LOAD"data/six-c3.scr",12288
220 PSG 16,22,17,2
221 REM ch-a1 on
222 PSG 23,62
225 GOSUB 900:REM 500 tick delay
228 REM E3 in ch-b1
229 LOAD"data/six-e3.scr",12288
230 PSG 18,168,19,1
231 REM ch-a1,b1 on
232 PSG 23,60
235 GOSUB 900:REM 500 tick delay
238 REM G3 in ch-c1
239 LOAD"data/six-g3.scr",12288
240 PSG 20,101,21,1
...
751 LOAD"data/six-voice.scr",12288
